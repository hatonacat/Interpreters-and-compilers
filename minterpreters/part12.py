...
class SymbolTableVisitor(Visitor):
    ...
    def visit_VarDeclNode(self, node):
        ...
        var_symbol = self.symbol_table.lookup(var_type)
        self.symbol_table.define(VarSymbol(var_name, var_symbol))
...
if __name__ == "__main__":
    ...
    sym_table = SymbolTableVisitor()
    sym_table.visit_ProgramNode(tree_head)
